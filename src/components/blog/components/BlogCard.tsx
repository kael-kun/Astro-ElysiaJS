  ...
  return (
    <Card className="h-full flex flex-col overflow-hidden hover:shadow-lg transition-shadow duration-200">
      ...
      <div className="flex-1 p-4 flex flex-col">
        <h3 className="font-semibold text-lg text-gray-900 line-clamp-2 mb-2">{blog.title || "Untitled Blog"}</h3>

        {blog.description && <p className="text-gray-500 text-sm line-clamp-2 mb-4 flex-1">{blog.description}</p>}
